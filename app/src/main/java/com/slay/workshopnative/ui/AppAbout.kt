...
internal data class AppNoticeItem(val title: String, val body: String)
...
internal object WorkshopNativeAbout {
    ...
    val highlights = listOf("开源免费", "匿名优先", "官方数据源")

    val disclaimerItems =
        listOf(
            AppNoticeItem(title = "开源免费", body = "本软件开源免费，仅提供客户端工具本身，不提供付费解锁、资源售卖或私有后端。"),
            AppNoticeItem(title = "匿名优先", body = "公开创意工坊内容建议优先使用匿名访问；如果只是下载公开条目，能匿名就匿名。"),
            AppNoticeItem(
                title = "官方来源",
    ...
    val usageBoundaryItems =
        listOf(
            ...
            AppNoticeItem(
                title = "用户责任",
                body =
                    "请仅访问、下载和使用你有合法权限获取的内容，并自行遵守 Steam 平台规则、内容作者授权条款及所在地法律法规。因不当使用本应用造成的风险、损失或纠纷，由使用者自行承担。",
            ),
            AppNoticeItem(
                title = "权利反馈",
