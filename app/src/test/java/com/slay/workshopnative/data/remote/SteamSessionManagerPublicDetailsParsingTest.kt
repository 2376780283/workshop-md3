...
class SteamSessionManagerPublicDetailsParsingTest {
    ...
    fun lenientNullableLongSerializer_returns_null_for_overflow_value() {
        val decoded = json.decodeFromString<LongWrapper>("""{"value":18446744073709551615}""")
    ...
    fun lenientNullableLongSerializer_accepts_regular_number_and_string() {
        val numberDecoded = json.decodeFromString<LongWrapper>("""{"value":123456789}""")
        val stringDecoded = json.decodeFromString<LongWrapper>("""{"value":"987654321"}""")
